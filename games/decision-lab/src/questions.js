    ...
    questions: [
      {
        ...
        explanation: 'Both countries show a pandemic-era spike between 2020 and 2021, then prices ease back from 2022 as interest rates rose.',
      },
      {
        id: 'r3q2',
        type: 'multiple_choice',
      ...
      },
      {
        ...
        prompt: 'Which year stands out as an anomaly?',
        options: ['2014 — biggest decline', '2018 — smallest decline', '2020 — extreme drop', '2024 — sudden rebound'],
        correctAnswer: '2020 — extreme drop',
        explanation: '2020 lost ~2,300 pubs net — more than double the typical year. COVID lockdowns hit hospitality hardest that year.',
      },
      {
        id: 'r3q4',
        type: 'multiple_choice',
      ...
      },
      {
        ...
        options: [
          'Steady decline — deposits have got smaller',
          'Steady rise — deposits have become much bigger as a share of price',
          'No clear direction — bounces around',
          'Cyclical — exactly 5 years up, 5 years down',
        ],
        correctAnswer: 'Steady rise — deposits have become much bigger as a share of price',
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Build a new feature (matches feature requests)', 'Rewrite the billing system', 'Fix small bugs in the bug tracker', 'Improve internal tooling'],
        correctAnswer: 'Rewrite the billing system',
        explanation: 'Billing causes 38% of tickets — by far the largest slice. Fixing that source kills more tickets than any other project. Always attack the biggest cause first.',
      },
      {
        id: 'r4q5',
        type: 'multiple_choice',
    ...
    questions: [
      {
        ...
        explanation: 'BEV share went from 1.6% to 19.6% — a 12× rise. Hybrids grew too but much more slowly (~2.4×). Lean into BEVs.',
      },
      {
        id: 'r5q2',
        type: 'multiple_choice',
        ...
        prompt: 'A brand has £100k advertising budget for 2026. What\'s the most defensible reading?',
        options: [
          'Pour it all into X/Twitter — usage will rebound',
          'Split equally — they all matter the same',
          'Lean into TikTok — fastest-growing audience by far',
          'Spend it on Instagram — biggest absolute base',
        ],
        correctAnswer: 'Lean into TikTok — fastest-growing audience by far',
        explanation: 'TikTok 6× in 5 years (200m → 1,200m) — explosive trajectory. Instagram is steady but slowing; X/Twitter is shrinking sharply.',
      },
      {
        id: 'r5q3',
        type: 'multiple_choice',
        ...
        prompt: 'Most accurate insight:',
        options: [
          'Temperatures have been stable for decades',
          'Rate of warming has accelerated since 2000 — not a linear trend',
          'It got warmer 1980→1990 then cooled steadily',
          'Annual values bounce around random — no signal',
        ],
        correctAnswer: 'Rate of warming has accelerated since 2000 — not a linear trend',
        explanation: '1980→2000 added ~0.22°C (20 yrs). 2000→2024 added ~0.75°C (24 yrs) — roughly 3× faster pace. The slope is steepening, not steady.',
      },
      {
        id: 'r5q4',
        type: 'multiple_choice',
        ...
        options: [
          'No competition — graduates don\'t apply to startups',
          'High competition — most grads target Big Tech and Finance, so you compete with those packages',
          'Easy win — startups are the most desirable destination',
          'Graduates don\'t care about employer brand',
        ],
        correctAnswer: 'High competition — most grads target Big Tech and Finance, so you compete with those packages',
        explanation: '50% of graduates aim at Big Tech (28%) + Finance (22%). Startups get 14%. To attract talent you\'re competing against those companies\' offers — pay, prestige, training.',
      },
      {
        id: 'r5q5',
        type: 'multiple_choice',
        ...
        options: [
          'Churn is a fixed cost of doing business, nothing to do',
          'Focus on the first 3–6 months — that\'s when most new subscribers leave',
          'Long-term subscribers are the problem',
          'The chart shows no meaningful pattern',
        ],
        correctAnswer: 'Focus on the first 3–6 months — that\'s when most new subscribers leave',
        explanation: 'New subscribers churn at 6–12% in months 1–6 then stabilise to ~3% by month 24. Long-tenured subs are at 2% (much stickier). Onboarding improvements pay back fastest.',
      },
    ],
  },
];
